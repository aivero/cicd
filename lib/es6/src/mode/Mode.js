  ...
  return Task$Std.flatMap(Task$Std.seq2([
                ...
                return Task$Std.to(Array$Std.map(ints$1, (function (triggered) {
                                  ...
                                  return {
                                          ...
                                          needs: Array$Std.concat(triggered.needs, triggers),
...
function load(param) {
  ...
  var ints;
  if (kind == null) {
    ints = (component == null) ? Git.findInts(undefined) : Manual.findInts(allInts);
  } else {
    switch (kind) {
      case "git" :
  ...
  return Task$Std.flatMap(ints$1, Job.load);
}
