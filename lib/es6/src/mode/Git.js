...
function getLastRev(param) {
  ...
  var curBranch = match._0;
  if (curBranch === "master" && match$1.TAG === /* Ok */0) {
  ...
  var parentBranch = getParentBranch(undefined);
  return Task$Std.map(getMergeBase(curBranch, "remotes/origin/" + parentBranch), (function (ref) {
                return [
                        parentBranch,
                        ref
                      ];
