...
function getJob(param) {
  ...
  return Result$Std.flatMap(Result$Std.seq4(Tuple$Std.map4([
                ...
                var tags$1 = Array$Std.empty(tags) ? (Console$Std.log("Docker Mode: Tags are set, overriding profile-generated tags"), tags) : Result$Std.toOption(Profile.getTags(profile));
