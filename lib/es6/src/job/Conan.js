...
function getJob(allInts, buildOrder) {
  ...
  return Array$Std.concat(Array$Std.flatMapWithIndex(buildOrder, (function (index, group) {
                    ...
                    var groupJobNeeds = Array$Std.uniq(group$1 !== undefined ? Array$Std.flatMap(group$1, (function (pkg) {
                    ...
                    var groupJob_1 = {
                      ...
                      script: ["echo"],
                      after_script: Jobt.$$default.after_script,
                      needs: Array$Std.uniq(groupJobNeeds),
                      services: Jobt.$$default.services,
                      cache: Jobt.$$default.cache,
                      retry: Jobt.$$default.retry,
                      artifacts: Jobt.$$default.artifacts,
                    ...
                    var match = Array$Std.length(groupJobNeeds);
                    var groupJobInOutPut = match !== 0 ? [groupJob] : [];
                    var match$1 = Array$Std.length(groupJobNeeds);
                    var groupJobNeededInOutPut = match$1 !== 0 ? [groupJobName] : [];
                                      ...
                                      return Array$Std.map(ints, (function ($$int) {
                                                    ...
                                                    return [
                                                            base.name + "/" + base.version,
                                                            {
                                                              ...
                                                              script: Jobt.$$default.script,
                                                              after_script: Array$Std.concat([
                                                                    "cd $CI_PROJECT_DIR/" + $$int.base.folder,
                                                                    "conan remove --locks"
                                                                  ], $$int.base.afterScript),
                                                              needs: Array$Std.uniq(Array$Std.concat(base.needs, groupJobNeededInOutPut)),
                                                              services: Jobt.$$default.services,
                                                              cache: Jobt.$$default.cache,
                                                              retry: Jobt.$$default.retry,
                                                              artifacts: Jobt.$$default.artifacts,
