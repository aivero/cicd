...
var $$extends = [
  ...
  [
    ".conan-x86_64",
    {
      ...
      image: Result$Std.toOption(Profile.getImage("linux-x86_64", Caml_option.nullable_to_opt(Deno.env.get("CONAN_DOCKER_REGISTRY")), Caml_option.nullable_to_opt(Deno.env.get("CONAN_DOCKER_PREFIX")), undefined)),
  ...
  [
    ".conan-armv8",
    {
      extends: [".conan"],
      variables: Jobt.$$default.variables,
      image: Result$Std.toOption(Profile.getImage("linux-armv8", Caml_option.nullable_to_opt(Deno.env.get("CONAN_DOCKER_REGISTRY")), Caml_option.nullable_to_opt(Deno.env.get("CONAN_DOCKER_PREFIX")), undefined)),
  ...
  [
    ".conan-x86_64-bootstrap",
    {
      ...
      variables: Jobt.$$default.variables,
      image: Option$Std.map(Result$Std.toOption(Profile.getImage("linux-x86_64", Caml_option.nullable_to_opt(Deno.env.get("CONAN_DOCKER_REGISTRY")), Caml_option.nullable_to_opt(Deno.env.get("CONAN_DOCKER_PREFIX")), undefined)), (function (image) {
              var name = image.name + "-bootstrap";
              return {
                      name: name,
  ...
  [
    ".conan-armv8-bootstrap",
    {
      extends: [".conan-armv8"],
      variables: Jobt.$$default.variables,
      image: Option$Std.map(Result$Std.toOption(Profile.getImage("linux-armv8", Caml_option.nullable_to_opt(Deno.env.get("CONAN_DOCKER_REGISTRY")), Caml_option.nullable_to_opt(Deno.env.get("CONAN_DOCKER_PREFIX")), undefined)), (function (image) {
              var name = image.name + "-bootstrap";
              return {
                      name: name,
                      entrypoint: image.entrypoint
...
function getJob(allInts, buildOrder) {
  ...
  return Array$Std.concat(Array$Std.flatMapWithIndex(buildOrder, (function (index, group) {
                ...
                "conan-upload",
                {
                  extends: Jobt.$$default.extends,
                  variables: Jobt.$$default.variables,
                  image: Result$Std.toOption(Profile.getImage(Profile.$$default, Caml_option.nullable_to_opt(Deno.env.get("CONAN_DOCKER_REGISTRY")), Caml_option.nullable_to_opt(Deno.env.get("CONAN_DOCKER_PREFIX")), undefined)),
