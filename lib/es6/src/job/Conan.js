...
var empty_conan_upload = [
  "conan-upload",
  empty_conan_upload_1
];
  ...
  [
    ".conan",
    {
      ...
      variables: Caml_option.some(Dict$Std.fromArray([
                ...
                [
                  "CARGO_HOME",
                  "$CI_PROJECT_DIR/.cargo_home"
                ],
                [
                  "CARGO_TARGET_DIR",
                  "$CI_PROJECT_DIR/.cargo_target"
                ],
                [
                  "CONAN_USER_HOME",
                  "$CI_PROJECT_DIR/.conan_home"
                ],
                [
                  "CONAN_DATA_PATH",
...
function getVariables(param) {
  ...
  return Dict$Std.fromArray(Array$Std.concat(Array$Std.concat([
                      [
                        "NAME",
                        match.name
                      ],
...
function init(ints) {
  ...
  return Task$Std.flatMap(Task$Std.flatMap(config, (function (param) {
                    return Task$Std.flatMap(Task$Std.fromResult(Result$Std.seq2(Tuple$Std.map2([
                                            "CONAN_LOGIN_USERNAME",
                                            "CONAN_LOGIN_PASSWORD"
                                          ], Env$Std.getError))), (function (param) {
                                  var passwd = param[1];
                                  var user = param[0];
                                  return Task$Std.flatMap(Task$Std.fromResult(Result$Std.seq(Array$Std.map([
                                                          "CONAN_REPO_INTERNAL",
                                                          "CONAN_REPO_DEV_INTERNAL",
                                                          "CONAN_REPO_PUBLIC",
                                                          "CONAN_REPO_DEV_PUBLIC"
                                                        ], Env$Std.getError))), (function (res) {
                                                return Task$Std.seq(Array$Std.map(res, (function (repo) {
                                                                  return Proc$Std.run([
                                                                              "conan",
                                                                              "user",
                                                                              user,
...
function getJob(allInts, buildOrder) {
  ...
  return Array$Std.concat(Array$Std.flatMapWithIndex(buildOrder, (function (index, group) {
                                  ...
                                  return Array$Std.map(ints, (function ($$int) {
                                                ...
                                                return [
                                                        base.name + "/" + base.version,
                                                        {
                                                          ...
                                                          needs: Array$Std.uniq(Array$Std.concat(base.needs, group !== undefined ? Array$Std.flatMap(group, (function (pkg) {
                                                                            var match = String$Std.split(pkg, "@#");
                                                                            if (match.length !== 2) {
                                                                              return [];
                                                                            }
                ...
                "conan-upload",
                {
                  ...
                  after_script: Jobt.$$default.after_script,
                  needs: needs !== undefined ? Array$Std.uniq(Array$Std.map(needs, (function (need) {
