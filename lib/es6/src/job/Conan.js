...
var $$extends = [
  ...
  [
    ".conan-x86_64",
    {
      ...
      image: Result$Std.toOption(Profile.getImage("linux-x86_64")),
  ...
  [
    ".conan-armv8",
    {
      extends: [".conan"],
      variables: Jobt.$$default.variables,
      image: Result$Std.toOption(Profile.getImage("linux-armv8")),
  ...
  [
    ".conan-x86_64-bootstrap",
    {
      ...
      variables: Jobt.$$default.variables,
      image: Option$Std.map(Result$Std.toOption(Profile.getImage("linux-x86_64")), (function (image) {
  ...
  [
    ".conan-armv8-bootstrap",
    {
      extends: [".conan-armv8"],
      variables: Jobt.$$default.variables,
      image: Option$Std.map(Result$Std.toOption(Profile.getImage("linux-armv8")), (function (image) {
              return image + "-bootstrap";
            })),
      tags: Jobt.$$default.tags,
      before_script: Jobt.$$default.before_script,
...
function getJob(ints, buildOrder) {
  ...
  return Array$Std.concat(Array$Std.flatMapWithIndex(buildOrder, (function (index, group) {
                    return Array$Std.flatMap(group, (function (pkg) {
                                  ...
                                  return Array$Std.map(ints$1, (function ($$int) {
                                                var base = $$int.base;
                                                ...
                                                return [
                                                        base.name + "/" + base.version,
                                                        {
                                                          ...
                                                          script: Jobt.$$default.script,
                                                          after_script: Jobt.$$default.after_script,
                                                          needs: Array$Std.uniq(Array$Std.concat(base.needs, group !== undefined ? Array$Std.map(group, (function (pkg) {
                                                                            var match = String$Std.split(pkg, "@#");
                                                                            if (match.length !== 2) {
                                                                              return "invalid-pkg";
                                                                            } else {
                ...
                "conan-upload",
                {
                  extends: Jobt.$$default.extends,
                  variables: Jobt.$$default.variables,
                  image: Result$Std.toOption(Profile.getImage(Profile.$$default)),
                  ...
                  script: Array$Std.concat([
                        ...
                        "conan user $CONAN_LOGIN_USERNAME -p $CONAN_LOGIN_PASSWORD -r $CONAN_REPO_DEV_INTERNAL",
                        "conan user $CONAN_LOGIN_USERNAME -p $CONAN_LOGIN_PASSWORD -r $CONAN_REPO_DEV_PUBLIC"
                      ], Array$Std.flatMap(Array$Std.reduce(Array$Std.flatten(buildOrder), (function (pkgs, pkg) {
                                  var match = String$Std.split(pkg, "@#");
                                  if (match.length !== 2) {
                                    return pkgs;
                                  }
