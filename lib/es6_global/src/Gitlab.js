...
function generateJob(job) {
  ...
  return Flat.array([
              ...
              $$extends !== undefined ? ["  extends: [" + Belt_Array.joinWith($$extends, ", ", (function (a) {
                          return a;
                        })) + "]"] : [],
              tags !== undefined ? ["  tags: [" + Belt_Array.joinWith(tags, ", ", (function (a) {
                          return a;
                        })) + "]"] : [],
              services !== undefined ? ["  services: [" + Belt_Array.joinWith(services, ", ", (function (a) {
                          return a;
                        })) + "]"] : [],
...
function generate(jobs) {
  ...
  return $$File.write(Curry._1(encode, base + Belt_Array.joinWith(Flat.array(Belt_Array.map(jobs$1, generateJob)), "\n", (function (a) {
                        return a;
