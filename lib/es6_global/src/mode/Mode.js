...
function load(param) {
  ...
  console.log("CI_JOB_MANUAL: " + Belt_Option.getExn((manual == null) ? undefined : Caml_option.some(manual)));
  var ints;
  if (kind == null) {
    ints = (manual == null) ? Git.findInts(undefined) : Manual.findInts(undefined);
  } else {
    switch (kind) {
      case "git" :
