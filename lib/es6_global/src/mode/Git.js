...
function handleConfigChange(confPath) {
  ...
  var intsOld = TaskResult.flatten(TaskResult.map(lastRev, (function (lastRev) {
  ...
  var filesOld = TaskResult.flatten(TaskResult.map(lastRev$1, (function (lastRev) {
              return Proc.run([
                          "git",
                          "ls-tree",
                          "-r",
...
function findInts(param) {
  ...
  var lastRev = getLastRev(undefined);
  return TaskResult.flatten(TaskResult.map(TaskResult.flatten(TaskResult.map(lastRev, (function (lastRev) {
