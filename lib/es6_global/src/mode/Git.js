...
function getCurBranch(param) {
  return $$Option.toResult(Caml_option.nullable_to_opt(Deno.env.get("CI_COMMIT_REF_NAME")), "CI_COMMIT_REF_NAME not defined!");
}
...
function getParentBranch(param) {
  var curBranch = Task.resolve(getCurBranch(undefined));
