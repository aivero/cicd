...
function handleConfigChange(confPath) {
  ...
  var filesOld = TaskResult.flatMap(lastRev, (function (lastRev) {
          return Proc.run([
                      "git",
                      "ls-tree",
                      "-r",
  ...
  var intsOld = TaskResult.flatMap(TaskResult.seq2([
            filesOld,
            lastRev
          ]), (function (param) {
  ...
  return TaskResult.flatMap(TaskResult.seq2([
                ...
                return TaskResult.resolve(cmpInts(param[0], param[1]));
              }));
}
