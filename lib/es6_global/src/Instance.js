...
function create($$int, folderPath) {
  ...
  reqs$1 = typeof reqs === "number" ? [] : (
      reqs.TAG === /* Array */3 ? $$Array.reduce(reqs._0, (function (reqs, req) {
  ...
  revReqs = typeof reqs$2 === "number" ? [] : (
      reqs$2.TAG === /* Array */3 ? $$Array.reduce(reqs$2._0, (function (reqs, req) {
                if (typeof req === "number") {
                  return [];
                } else if (req.TAG === /* String */0) {
                  return $$Array.concat(reqs, [req._0]);
  ...
  cmdsPre = typeof cmds === "number" ? [] : (
      cmds.TAG === /* Array */3 ? $$Array.reduce(cmds._0, (function (cmds, cmd) {
  ...
  cmds$2 = typeof cmds$1 === "number" ? [] : (
      cmds$1.TAG === /* Array */3 ? $$Array.reduce(cmds$1._0, (function (cmds, cmd) {
                if (typeof cmd === "number") {
                  return [];
                } else if (cmd.TAG === /* String */0) {
                  return $$Array.concat(cmds, [cmd._0]);
  ...
  cmdsPost = typeof cmds$3 === "number" ? [] : (
      cmds$3.TAG === /* Array */3 ? $$Array.reduce(cmds$3._0, (function (cmds, cmd) {
                if (typeof cmd === "number") {
                  return [];
                } else if (cmd.TAG === /* String */0) {
                  return $$Array.concat(cmds, [cmd._0]);
