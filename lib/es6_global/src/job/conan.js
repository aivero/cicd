...
function getLockFile(triples) {
  return Task.map(Flat.task(Task.map(Flat.task(Task.map(Flat.task(Task.map(triples, (function (res) {
                                        return Belt_Result.map(res, (function (triples) {
                                                      return Task.map(Promise.all(Belt_Array.map(triples, (function (triple) {
                                                                            var match = triple.int.name;
                                                                            var match$1 = triple.int.version;
                                                                            if (match !== undefined && match$1 !== undefined) {
                                                                              return Task.map(Proc.run(Belt_Array.concat([
                                                                                                  ...
                                                                                                  "create",
                                                                                                  "--ref=" + match + "/" + match$1,
                                                                                                  "--lockfile-out=" + match + "-" + match$1 + "-" + triple.info.revision + ".lock",
                                                                                                  "-pr=" + triple.profile
                                                                                                ], getArgs(triple.int))), (function (output) {
                                                                                            if (output.TAG === /* Ok */0) {
                                                                                              return {
                                                                                                      TAG: /* Ok */0,
                                                                                                      _0: triple
                                ...
                                return Belt_Result.map(res, (function (triples) {
                                              var locks = Belt_Array.map(triples, (function (triple) {
                                                      var match = triple.int.name;
                                                      var match$1 = triple.int.version;
                                                      if (match !== undefined && match$1 !== undefined) {
                                                        return match + "-" + match$1 + "-" + triple.info.revision + ".lock";
                                                      } else {
                                                        return "";
                                                      }
                                                    }));
