...
function getArgs(name, $$int) {
  ...
  tmp = typeof sets === "number" ? [] : (
      sets.TAG === /* Object */2 ? $$Array.map(Dict.entries(sets._0), (function (param) {
                var val = param[1];
                var key = param[0];
  ...
  tmp$1 = typeof opts === "number" ? [] : (
      opts.TAG === /* Object */2 ? $$Array.map(Dict.entries(opts._0), (function (param) {
                var val = param[1];
                var key = param[0];
                if (typeof val === "number" || !(val.TAG === /* Bool */4 && val._0)) {
                  return [
...
function getBuildOrder(ints) {
  ...
  Console.log(locks);
  var bundle = $$Array.empty(locks) ? Task.resolve({
          TAG: /* Ok */0,
          _0: ""
        }) : Proc.run($$Array.concat([
              "conan",
              "lock",
              "bundle",
              "create",
                ...
                return $$Array.flatMap(group, (function (pkg) {
                              ...
                              return $$Array.concat($$Array.map(ints$1, (function ($$int) {
                                                ...
                                                return {
                                                        ...
                                                        tags: undefined,
                                                        script: undefined,
                                                        needs: $$Array.concat($$int.base.reqs, group !== undefined ? $$Array.map(group, (function (pkg) {
                                                                      var match = $$String.split(pkg, "#");
                                                                      if (match.length !== 2) {
                                                                        throw {
                                                                              RE_EXN_ID: "Match_failure",
